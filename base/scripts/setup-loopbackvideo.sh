...
sudo apt-get install -y user-mode-linux linux-headers-$(uname -r) build-essential gstreamer1.0-tools gstreamer1.0-libav gstreamer1.0-plugins-good libvpx1 libopus0
